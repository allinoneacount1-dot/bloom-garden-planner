...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DCdhdd-A.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-DBw_36d3.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dgl_c6qX.mjs"),
		import("./start-D13VAkNK.mjs"),
