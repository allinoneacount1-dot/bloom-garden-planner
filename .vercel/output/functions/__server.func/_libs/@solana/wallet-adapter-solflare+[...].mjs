import { A as WalletNotConnectedError, D as WalletDisconnectionError, E as WalletDisconnectedError, F as WalletSignMessageError, I as WalletSignTransactionError, M as WalletPublicKeyError, N as WalletSendTransactionError, O as WalletError, R as PublicKey, S as scopePollingDetectionStrategy, T as WalletConnectionError, _ as BaseMessageSignerWalletAdapter, b as WalletReadyState, j as WalletNotReadyError, k as WalletLoadError, v as isVersionedTransaction, w as WalletConfigError, x as isIosAndRedirectable } from "../@solana-mobile/wallet-adapter-mobile.mjs";
...
var SolflareWalletAdapter = class extends BaseMessageSignerWalletAdapter {
	...
	async connect() {
		try {
			...
			let SolflareClass;
			try {
				SolflareClass = (await import("../@solflare-wallet/sdk+[...].mjs").then((n) => n.t)).default;
			} catch (error) {
...
//#endregion
export { SolflareWalletAdapter as t };
